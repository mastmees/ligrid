...
#
# taken from http://web.fastermac.net/~MacPgmr/Lazarus/
# and changed symlinking binary to universal binary creation with lipo
#
exename=$1
appname=$2
if [ "$appname" = "" ]
...
# ln -s
  lipo -create -arch i386 $exename -output $appfolder/Contents/MacOS/$exename
